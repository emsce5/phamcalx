...
?>
    ...
    <div class= 'container'>
      <h1>Partial Manual Exchange Calculations</h1>
      <h4>Given a final goal hematocrit this calculation provides an estimate for the volumes of saline, and blood to be transfused, as well as an estimation of the patient's post therapy hemoglobinS.</h4>
      <h5>Some facilities use 500ml for volume removed, and 24% as the minimum allowable post transfusion hematocrit.</h5>

      <form action= "partial_manual_do.php" method="get">
        <div class="row">
          <div class="col-sm-4">
          ...
          <div class= "form-group">
            <label>Minimal Allowable Hematocrit</label>
            <div class="input-group">
          ...
          <div class= "form-group">
            <label>Desired Final Hematocrit</label>
            <div class="input-group">
          ...
          <div class= "form-group">
            <label>Whole Blood Volume Removed</label>
            <div class="input-group">
