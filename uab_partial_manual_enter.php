...
?>
    ...
    <div class= 'container'>
      <h1>Partial Manual Exchange Calculations for the UAB Sickle Cell Clinic</h1>
      <h4>For a known transfused volume of saline and packed red blood cells this calculation provides an estimate the patient's post therapy hematocrit and hemoglobinS.</h4>

      <form action= "uab_partial_manual_do.php" method="get">
        <div class="row">
          <div class="col-sm-4">
          ...
          <div class= "form-group">
            <label>Volume of Blood Transfused</label>
            <div class="input-group">
              <input class="form-control" type= "number" step= "any" name= "volb">
          ...
          <div class= "form-group">
            <label>Volume of Saline Infused</label>
            <div class="input-group">
              <input class="form-control" type= "number" step= "any" name= "vols">
              <div class="input-group-addon">ml</div>
            </div>
          </div>

          <div class= "form-group">
            <label>Volume Whole Blood Removed</label>
            <div class="input-group">
              <input class="form-control" type= "number" step= "any" name= "volr">
              <div class="input-group-addon">ml</div>
            </div>
          </div>
